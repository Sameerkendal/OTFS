...
% User switches
% =========================
ChannelEstimation = "SP";          % "Perfect", "Estimator", "Noisy", "SP"
            ...
            for a = 1:length(seedGen)
                ...
                for ifram = 1:N_fram
                    ...
                    switch ChannelEstimation
                        ...
                        case "SP"
                            ...
                            if SP_useEstimatedSupport
                                ...
                                [k_i_sp, l_i_sp, scoreMap] = estimate_support_from_pilot_rcp( ...
                                    r, s_pilot, N, M, kSearch, lSearch, SP_numPaths);
                                ...
                                if SP_plotSupportMap && ifram == 1 && a == 1
                                    ...
                                    title('SP support correlation map (RCP atoms)');
                                end
                    ...
                    if strcmp(ChannelEstimation, "SP")
                        ...
                        fprintf('SP support mode: %s\n', ternary_string(SP_useEstimatedSupport, 'Estimated', 'Oracle'));
                    end
...
title('RCP-OTFS: Channel NMSE (Log Scale)');
legend(curveLabels, 'Interpreter', 'none', 'Location', 'best');
...
function [kp_est, lp_est, scoreMap] = estimate_support_from_pilot_rcp( ...
    yVec, sPilot, N, M, kSearchSigned, lSearch, Psel)
    ...
    for ik = 1:numK
        for il = 1:numL
            ...
            Gcand = build_single_tap_Grcp(N, M, lCand, kCand);
            a = Gcand * sPilot;
