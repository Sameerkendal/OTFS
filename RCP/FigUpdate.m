%% Open existing .fig
h = openfig('CodingEffect_OTFSvsOFDM.fig');   % Open saved figure
...
plot_proc(h, plot_handles, '/home/sameer/OTFS/OTFS/SIMULATIONS/RCP_OTFS', ...
           'CodingEffect_OTFSvsOFDM', xlab, ylab, t);
